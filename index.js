...
const { UPDATE_USER_XP, CREATE_USER, UPDATE_USER } = require(`./utils/API.js`);
...
client.on(`ready`, () => {
    ...
    console.log();
    // console.log(moment.utc(`10-11-95`, [`MM/DD/YY`, `MM/DD/YYYY`, `MM-DD-YY`, `MM-DD-YYYY`, `DD/MM/YY`, `DD/MM/YYYY`, `DD-MM-YY`, `DD-MM-YYYY`]).format(`MM/DD/YYYY`));
...
client.on(`message`, async message => {
    ...
    // MESSAGE LOG //
    log && console.log(`    [#${msgChannel}] ${msgAuthor}: ${msg}`);
